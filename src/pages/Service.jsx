...
function Service() {
  ...
  <Box textAlign="center" mb={4}>
    ...
    >
      Explore our wide range of services designed to meet your needs with excellence and precision.
    </Typography>
  </Box>
  ...
  <Grid container spacing={{ xs: 2, md: 3 }} justifyContent="center">
    {services.map((service) => (
      <Grid 
        ...
        sm={12}   // Full width on small screens (1 card per row)
        md={12}   // Full width on medium screens (1 card per row)
        lg={4}    // 3 cards per row on large screens (12/4 = 3)
